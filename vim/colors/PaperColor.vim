...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
  ...
  call s:HL("Conditional", s:blue, "", "bold")
  call s:HL("Repeat", s:blue, "", "bold")
  ...
  call s:HL("htmlTagN", s:green, "", "bold")
  call s:HL("htmlSpecialTagName", s:green, "", "")
...
call s:HL("cssClassName", s:pink, "", "")
  ...
  call s:HL("javaTypedef", s:purple, "", "")
  call s:HL("javaFuncDef", s:foreground, "", "bold")
  call s:HL("javaVarArg", s:aqua, "", "bold")
  call s:HL("javaMethodDef", s:green, "", "bold")
  call s:HL("javaClassDecl", s:blue, "", "bold")
  call s:HL("javaScopeDecl", s:blue, "", "bold")
  call s:HL("javaStorageClass", s:blue, "", "bold")
  call s:HL("javaBoolean", s:green, "", "bold")
  call s:HL("javaConstant", s:blue, "", "")
  call s:HL("javaCommentTitle", s:red, "", "")
  call s:HL("javaDocTags", s:aqua, "", "")
  call s:HL("javaDocComment", s:red, "", "")
  call s:HL("javaDocParam", s:purple, "", "")
  call s:HL("javaClasses", s:green, "", "bold")
